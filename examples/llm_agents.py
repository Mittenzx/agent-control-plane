...
from control_plane.core import Agent, AgentInfo, AgentCapability, Task
...
def create_research_agent(
    name: str = "researcher", control_plane: Optional[ControlPlane] = None
) -> ResearchAgent:
    """Create a research agent."""
    import uuid

    info = AgentInfo(id=str(uuid.uuid4()), name=name, type="research_agent", capabilities=[])
    return ResearchAgent(info, control_plane=control_plane)


def create_coder_agent(
    name: str = "coder", control_plane: Optional[ControlPlane] = None
) -> CoderAgent:
    """Create a coder agent."""
    import uuid

    info = AgentInfo(id=str(uuid.uuid4()), name=name, type="coder_agent", capabilities=[])
    return CoderAgent(info, control_plane=control_plane)


def create_planner_agent(
    name: str = "planner", control_plane: Optional[ControlPlane] = None
) -> PlannerAgent:
    """Create a planner agent."""
    import uuid

    info = AgentInfo(id=str(uuid.uuid4()), name=name, type="planner_agent", capabilities=[])
