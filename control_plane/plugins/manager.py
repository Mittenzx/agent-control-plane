...
class PluginManager:
    ...
    async def load_plugin(self, plugin_class: Type[AgentPlugin], 
                          config: Optional[Dict[str, Any]] = None) -> AgentPlugin:
...
class AgentFactory:
    ...
    async def create_agent(self, type_name: str, agent_info: AgentInfo, 
